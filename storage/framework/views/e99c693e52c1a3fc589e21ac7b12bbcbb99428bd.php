...
<script type="text/javascript">
    $(function () {
        ...
        $("#pdf_file").on('click', function(e){
            ...
            location.reload();
            // $.ajax({
            //     url: "<?php echo e(URL('pdf_file')); ?>"+'/'+consultationID,
            //     type: "GET",
            //     contentType: false,
            //     cache: false,
            //     processData: false,
        ...
        $("#view_consultation").on('click',function(e){
            ...
            $.get("<?php echo e(URL('viewPrevious')); ?>", function (data) { 
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Workshop\resources\views/index.blade.php ENDPATH**/ ?>